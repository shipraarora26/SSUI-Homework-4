...
class App extends Component {
  constructor(props) {
    ...
    this.goProductMenu = this.goProductMenu.bind(this);
  ...
  goHome() {
    ...
    this.render()
    // do regex replace on li's in the header, remove any active class and then add active class to the current state link
  }
  ...
  getComponent() {
    if (this.state.displayPage == 'ProductMenu') {
      return <ProductMenu />;
    } else if (this.state.displayPage == 'ShoppingCart') {
      return <ShoppingCart />;
    } else if (this.state.displayPage == 'HomePage') {
      return <HomePage />;
    } else if (this.state.displayPage == 'ContactUs') {
      return <ContactUs />;
    } else if (this.state.displayPage.includes('ProductDetails')) {
      // id = this.state.displayPage
        ...
        <ul>
            ...
            <g id="Welcome" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="Tablet-Portrait" transform="translate(-173.000000, -43.000000)" fill="#FFFFFF">
                    <g id="Group" transform="translate(173.000000, 38.000000)">
                        <g id="cinnamon-roll" transform="translate(0.000000, 5.000000)" fill-rule="nonzero">
                        ...
                        <text id="Bun-Bun-Bake-Shop" font-family="Montez-Regular, Montez" font-size="35" font-weight="normal">
          ...
          <div className="navLinksRight">
            ...
            <svg className="shoppingCartIcon">
              <defs></defs>
                <g id="Welcome" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" opacity="0.850430254">
                    <g id="Home" transform="translate(-947.000000, -49.000000)" fill-rule="nonzero" fill="#FFFFFF">
            ...
            <span id="shoppingCartValue">0</span></a>
            </li>
          </div>
        </ul>
      </div>
